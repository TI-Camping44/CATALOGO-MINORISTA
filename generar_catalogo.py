...
def main():
    try:
        ...
        # PASO VITAL: Extraemos los productos SIN imágenes primero para que Odoo no corte el teléfono
        ...
        # PASO SEGURO: Descargamos las imágenes en paquetitos de 300
        ...
        <script>
            ...
            function formatLiquidation(sku, precioOriginal) {
                ...
                // Si justo no está en la lista de exactos, igual hace el 30% como salvavidas
                if (!precioOriginal || precioOriginal === '-') return '-';
                ...
                items.forEach(p => {
                    ...
                    for (const [tarifa, precio] of Object.entries(p.p)) {
                        ...
                        if (p.h === '🔥 LIQUIDACIÓN') {
                            ...
                            // SI EL PRECIO ES IGUAL (MARKETING), NO LO TACHAMOS, SOLO PONEMOS ROJO
                    ...
                    try {
                        ...
                        productosFiltrados.forEach(p => {
                            ...
                            tarifasSeleccionadas.forEach(t => { 
                                if (p.p[t]) { 
                                    if (p.h === '🔥 LIQUIDACIÓN') {
                                        preciosFila.push(formatLiquidation(p.c, p.p[t]) + " (30% OFF)"); 
                                    } else {
