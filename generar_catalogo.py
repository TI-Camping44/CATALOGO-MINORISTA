...
def main():
    try:
        ...
        for p in products:
            ...
            # AHORA EL PRODUCTO SE VA A SU MARCA SIEMPRE (Ignora si es liquidacion para la caja)
            hoja = "OTRO"
        ...
        # Generar los botones dinámicos (calculando los de oferta al vuelo)
