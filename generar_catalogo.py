...
def main():
    try:
        ...
        <style>
            ...
            .check-group{display:flex;flex-wrap:wrap;gap:18px;align-items:center;}
        ...
        <div class='col-12 col-lg-10 py-3'>
            ...
            <div class='pdf-panel shadow-sm mb-3'>
                <div class='check-group'>
                    <span class='pdf-panel-title pe-2'>📄 COTIZACIÓN PDF:</span>
                    ...
                    <div class='form-check form-check-inline m-0 border-start ps-3 ms-1'><input class='form-check-input' type='checkbox' id='chkMostrarStock' checked><label class='form-check-label small text-muted fw-bold' for='chkMostrarStock'>📦 Stock</label></div>
                    <div class='form-check form-check-inline m-0 border-start ps-3 ms-1'><input class='form-check-input' type='checkbox' id='chkOcultarAgotados' checked><label class='form-check-label small text-muted fw-bold' for='chkOcultarAgotados'>🚫 Ocultar Agotados</label></div>
                </div>
