        ...
        <script>
            ...
            function renderizarPagina() {
                ...
                items.forEach(p => {
                    ...
                    // Aseguramos que si esta en liquidacion, dibuje el precio SALGS igual aunque odoo mande 0.0
                ...
                setTimeout(async () => {
                    try {
                        ...
                        productosFiltrados.forEach(p => {
                            ...
                            // Aseguramos que SALGS este presente internamente si esta en liquidacion
